...
Transpara's trends visualization tool empowers you to monitor your business performance in real time closely. Trends can provide insights into your business's performance over time. Key performance indicators (KPI) trends are vital to Transpara products, allowing you to visualize data and track your key performance indicators efficiently. In this guide, we will explore the visualization features available to you when using KPIs trends in Transpara.

:::info Trend Types
Inside Transpara, you can access several trend types, including KPI, SPC (Statistical Process Control), and multiple-pin trends. The use of each trend type varies depending on your specific use case.
...
To access a KPI trend, follow these steps:

1. Access [**Visual KPI**](#) platform.
2. Navigate to the **Dashboard** tab.
3. Click on the **Expand** button at the top-right corner of your desired KPI.
...
You'll access the visualization panel for the selected KPI.
...
1. **KPI data**: On the center of the screen you find thegraph with KPI data. Horizontal lines represent limits or targets, which you can customize as needed. The limits and targets allow you to get insights about the current KPI behavior quickly.
...
If you have forecast data available, it will be displayed at the right of the vertical dashed line on the trend.

## Features of the KPI Panel

Access the KPI panel features by clicking on the buttons located at the top-left. Below is a list and description of the existing options from left to right.

- **Trend Options**:

  - **Trend Scale**: Choose between **Single Scale** if you are analyzing a single KPI or related KPIs or **Multiple Scales** if you are dealing with KPIs related to different variables or varying scales of magnitude.
...
When you have other tools selected, you can still perform zoom operations:

- Press **ctrl** and scroll the mouse up/down to zoom in/out the X-axis.
- Press **alt** and scroll the mouse up/down to zoom in/out the Y-axis.
...
- **Cursor Mode**: Hover over the KPI trend to view values for specific instances. You can lock values on the screen by clicking.
