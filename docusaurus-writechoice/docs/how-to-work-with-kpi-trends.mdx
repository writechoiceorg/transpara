...
- **Time Range**: Define the time range used to present KPI trend data. Choose from predefined options or create a custom range. When defining custom data ranges, use the symbol described in the table below. As example, let's define a custon time range composed by the data from the last 7 days:
...
<ul>
  <ul>
    <li>Hold ctrl and scroll the mouse up/down to zoom in/out the X-axis.</li>
    <li>Hold alt and scroll the mouse up/down to zoom in/out the Y-axis.</li>
    <li>Scroll the moute up/down to zoom in/out the trend.</li>
  </ul>
</ul>
